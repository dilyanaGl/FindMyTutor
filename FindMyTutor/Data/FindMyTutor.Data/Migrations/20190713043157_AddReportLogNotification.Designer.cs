...
namespace FindMyTutor.Data.Migrations
{
    ...
    [Migration("20190713043157_AddReportLogNotification")]
    partial class AddReportLogNotification
    {
            ...
            modelBuilder.Entity("FindMyTutor.Data.Models.ReportedComment", b =>
                {
                    ...
                    b.HasOne("FindMyTutor.Data.Models.FindMyTutorUser", "Creator")
                        .WithMany("ReportedComments")
                        .HasForeignKey("CreatorId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FindMyTutor.Data.Models.FindMyTutorUser", "Reporter")
                        .WithMany("MadeReportsForComment")
