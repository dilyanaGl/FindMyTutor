...
namespace UnitTests.MessagesTests
{
    public class MessageTest
    {
        ...
        {
            Assert.Single(this.serviceMock.Object.GetUserMessages("a"));
            Assert.Empty(this.serviceMock.Object.GetUserMessages("e"));
        ...
        {
            Assert.Equal(3, this.serviceMock.Object.GetFullCorrespondence("a", "b").Count());
        ...
        {
            var mail = this.serviceMock.Object.GetMail("b");

            Assert.Equal(2, 
               mail.First(p => p.SenderId == "a").MessagesCount);
            Assert.Single(this.serviceMock.Object.GetMail("a").Where(p => p.SenderId == "b")); 
        }
